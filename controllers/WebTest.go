...
func (c *MainController) AlertTest() {
	...
	case "workwechat":
		...
		ret := SendWorkWechat(beego.AppConfig.String("WorkWechat_ToUser"), beego.AppConfig.String("WorkWechat_ToParty"), beego.AppConfig.String("WorkWechat_ToTag"), "markdown", WorkwechatMessage, logsign)
		c.Data["json"] = ret
	case "bddx":
		MobileMessage := "PrometheusAlertCenter测试告警"
